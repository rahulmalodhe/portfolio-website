    ...
    >
      <div className="flex items-center justify-center">
        <div className="relative">
          ...
          <motion.span
            className="absolute bottom-[10px] right-[30px] text-4xl"
            initial={{ opacity: 0, scale: 0 }}
            animate={{ opacity: 1, scale: 1 }}
            transition={{
              type: "spring",
      ...
      >
        <span className="font-bold">Hello, I am Yashaswini.</span> A Passionate{" "}
      ...
      >
        ...
        <a
          ...
          href="https://www.linkedin.com/in/yashaswini-r-bedhre/"
          target="_blank"
        >
          <BsLinkedin />
        </a>
        ...
        <a
          ...
          href="https://www.behance.net/yashaswinibedhre"
          target="_blank"
        >
          <FaBehanceSquare />
        </a>
